...
(2, 1, 'credit_bond_level_1', '一级库', 'credit_bond', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '信用债一级库', '一级库', 101, 'bond:standard-upgrade', '债券标准升库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 50, 0, 0, NULL, NULL, 0, NULL, 0, 1, 1, 'enabled', 0, NOW(), NOW()),
(3, 1, 'credit_bond_level_2', '二级库', 'credit_bond', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '信用债二级库', '二级库', 102, 'bond:standard-downgrade', '债券标准降库流程', 114, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 50, 0, 0, NULL, NULL, 0, NULL, 0, 1, 2, 'enabled', 0, NOW(), NOW()),
(4, 1, 'credit_bond_level_3', '三级库', 'credit_bond', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '信用债三级库', '三级库', 101, 'bond:standard-upgrade', '债券标准升库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 1, 0, 0, NULL, NULL, 0, NULL, 0, 1, 3, 'enabled', 0, NOW(), NOW()),
(5, 1, 'credit_bond_level_4', '四级库', 'credit_bond', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '信用债四级库', '四级库', 102, 'bond:standard-downgrade', '债券标准降库流程', 114, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 50, 1, 0, NULL, NULL, 0, NULL, 0, 1, 4, 'enabled', 0, NOW(), NOW()),
(6, 1, 'credit_bond_level_5', '五级库', 'credit_bond', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '信用债五级库', '五级库', 102, 'bond:standard-downgrade', '债券标准降库流程', 114, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 100, 0, 0, NULL, '制造业', 0, NULL, 0, 1, 5, 'enabled', 0, NOW(), NOW()),
(7, NULL, 'offshore_bond_root', '境外债库', 'offshore_bond', 1, '["CIBM"]', '["bond"]', '境外债库', '境外债库', 105, 'bond:fast-inbound', '债券快速入库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'any', 'any', 50, 0, 0, NULL, NULL, 0, NULL, 0, 2, 1, 'enabled', 0, NOW(), NOW()),
...
(10, 9, 'special_account_level_1', '一级库', 'special_account', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '专户一级库', '专户一级库', 101, 'bond:standard-upgrade', '债券标准升库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 50, 0, 0, NULL, NULL, 0, NULL, 0, 4, 1, 'enabled', 0, NOW(), NOW()),
(11, 9, 'special_account_level_2', '二级库', 'special_account', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '专户二级库', '专户二级库', 102, 'bond:standard-downgrade', '债券标准降库流程', 114, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 50, 0, 0, NULL, NULL, 0, NULL, 0, 4, 2, 'enabled', 0, NOW(), NOW()),
(12, 9, 'special_account_level_3', '三级库', 'special_account', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '专户三级库', '专户三级库', 101, 'bond:standard-upgrade', '债券标准升库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 50, 0, 0, NULL, NULL, 0, NULL, 0, 4, 3, 'enabled', 0, NOW(), NOW()),
(13, 9, 'special_account_level_4', '四级库', 'special_account', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '专户四级库', '专户四级库', 102, 'bond:standard-downgrade', '债券标准降库流程', 114, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 50, 0, 0, NULL, NULL, 0, NULL, 0, 4, 4, 'enabled', 0, NOW(), NOW()),
(14, 9, 'special_account_level_5', '五级库', 'special_account', 2, '["SSE","SZSE","CIBM"]', '["bond"]', '专户五级库', '专户五级库', 102, 'bond:standard-downgrade', '债券标准降库流程', 114, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'none', 'none', 100, 0, 0, NULL, NULL, 0, NULL, 0, 4, 5, 'enabled', 0, NOW(), NOW()),
...
(19, 18, 'crmw_core_pool', 'CRMW核心库', 'crmw', 2, '["SSE","SZSE","CIBM"]', '["bond"]', 'CRMW核心库', 'CRMW核心库', 105, 'bond:fast-inbound', '债券快速入库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'internal', 'internal', 50, 0, 0, NULL, NULL, 0, NULL, 0, 8, 1, 'enabled', 0, NOW(), NOW()),
(20, 18, 'crmw_watch_pool', 'CRMW关注库', 'crmw', 2, '["SSE","SZSE","CIBM"]', '["bond"]', 'CRMW关注库', 'CRMW关注库', 105, 'bond:fast-inbound', '债券快速入库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'internal', 'internal', 50, 0, 0, NULL, NULL, 0, NULL, 0, 8, 2, 'enabled', 0, NOW(), NOW()),
(21, 18, 'crmw_exit_watch_pool', 'CRMW退出观察库', 'crmw', 2, '["SSE","SZSE","CIBM"]', '["bond"]', 'CRMW退出观察库', 'CRMW退出观察库', 105, 'bond:fast-inbound', '债券快速入库流程', 113, 'bond:fast-outbound', '债券快速出库流程', 105, 'bond:fast-inbound', '债券快速入库流程', 107, 'bond:batch-inbound', '债券批量入库流程', 'internal', 'internal', 50, 0, 0, NULL, NULL, 0, NULL, 0, 8, 3, 'enabled', 0, NOW(), NOW()),
