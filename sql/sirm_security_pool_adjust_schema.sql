...
(
    ...
    `pool_type`        VARCHAR(32)  DEFAULT NULL COMMENT '投资池类型：与 ip_investment_pool.pool_type 一致（credit_bond=信用债 / offshore_bond=境外债 / convertible_bond=转债 / special_account=专户产品 / forbidden=禁投池 / observe=观察池 等）',
