...
(1, NULL, 'credit_bond_root', '信用债大库', 'credit_bond', 1, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
...
(2, 1, 'credit_bond_level_1', '一级库', 'credit_bond', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(3, 1, 'credit_bond_level_2', '二级库', 'credit_bond', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(4, 1, 'credit_bond_level_3', '三级库', 'credit_bond', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(5, 1, 'credit_bond_level_4', '四级库', 'credit_bond', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(6, 1, 'credit_bond_level_5', '五级库', 'credit_bond', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(7, NULL, 'offshore_bond_root', '境外债库', 'offshore_bond', 1, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(8, NULL, 'convertible_bond_root', '转债库', 'convertible_bond', 1, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(9, NULL, 'special_account_root', '专户产品', 'special_account', 1, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(10, 9, 'special_account_level_1', '一级库', 'special_account', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(11, 9, 'special_account_level_2', '二级库', 'special_account', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(12, 9, 'special_account_level_3', '三级库', 'special_account', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(13, 9, 'special_account_level_4', '四级库', 'special_account', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(14, 9, 'special_account_level_5', '五级库', 'special_account', 2, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 101, 'bond:standard-upgrade', '债券标准升库流程',
 102, 'bond:standard-downgrade', '债券标准降库流程',
 105, 'bond:fast-inbound', '债券快速入库流程',
...
(15, NULL, 'forbidden_root', '禁投池', 'forbidden', 1, JSON_ARRAY(), JSON_ARRAY('bond'),
 NULL,
 NULL, NULL, NULL,
 NULL, NULL, NULL,
 NULL, NULL, NULL,
