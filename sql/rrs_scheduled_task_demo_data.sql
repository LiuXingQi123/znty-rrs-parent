...
(1, 'auto_out_expired', '到期出池',
 '扫描配置了 auto_out 规则的启用池，将池内已到期证券自动调出',
 '0 0 2 * * ?', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 0, NOW(), NOW()),
(2, 'company_new_bond_auto_in', '主体下新债自动入池',
 '主体已在配置池内时，将其旗下未到期且尚未在目标池的债券自动入池',
 '0 0 3 * * ?', 0, '15-15', NULL, NULL, NULL, NULL, NULL, NULL,
 0, NOW(), NOW());
