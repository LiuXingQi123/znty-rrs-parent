...
(108, 108, 'bond:special-inbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":150,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"approval","label":"研究员B复核","x":400,"y":280,"shape":"rect","sub":"researcher-b","approvalStrategy":"preempt","approvalPersons":[{"subjectType":"role","subjectId":2,"subjectName":"信用研究组"},{"subjectType":"user","subjectId":2,"subjectName":"研究员2"}],"approvalRemark":"复核节点，支持角色和人员混选，任一处理人通过即可"},{"id":"n4","type":"approval","label":"研究员A修改","x":650,"y":280,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"驳回后由流程发起人修改并重新提交"},{"id":"n5","type":"approval","label":"研究总监审批","x":400,"y":410,"shape":"rect","sub":"research-director","approvalStrategy":"all","approvalPersons":[{"subjectType":"user","subjectId":2,"subjectName":"研究员2"},{"subjectType":"role","subjectId":4,"subjectName":"固收部"}],"approvalRemark":"终审节点，配置的全部处理人均需处理"},{"id":"n6","type":"auto","label":"O32自动审批","x":400,"y":540,"shape":"rect"},{"id":"n7","type":"end","label":"结束","x":400,"y":660,"shape":"circle"}]',
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND"},{"id":"e2","from":"n2","to":"n3","label":"提交","condRules":[],"condLogic":"AND"},{"id":"e3","from":"n3","to":"n4","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e4","from":"n4","to":"n3","label":"重新提交","condRules":[],"condLogic":"AND","routeAction":"approve"},{"id":"e5","from":"n3","to":"n5","label":"复核通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e6","from":"n5","to":"n7","label":"不通过","condRules":[{"field":"auditStatus","op":"eq","val":"不通过"}],"condLogic":"AND","routeAction":"reject"},{"id":"e7","from":"n5","to":"n6","label":"通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e8","from":"n4","to":"n7","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e9","from":"n6","to":"n7","label":"","condRules":[],"condLogic":"AND"}]',
 0, 0, 1, 1001, '2026-05-20 09:00:00', 1001, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(116, 116, 'bond:special-outbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":150,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"approval","label":"研究员B复核","x":400,"y":280,"shape":"rect","sub":"researcher-b","approvalStrategy":"preempt","approvalPersons":[{"subjectType":"role","subjectId":4,"subjectName":"固收部"},{"subjectType":"user","subjectId":6,"subjectName":"固收1"}],"approvalRemark":"复核节点，支持角色和人员混选，任一处理人通过即可"},{"id":"n4","type":"approval","label":"研究员A修改","x":650,"y":280,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"驳回后由流程发起人修改并重新提交"},{"id":"n5","type":"approval","label":"研究总监审批","x":400,"y":410,"shape":"rect","sub":"research-director","approvalStrategy":"preempt","approvalPersons":[{"subjectType":"user","subjectId":2,"subjectName":"研究员2"},{"subjectType":"role","subjectId":4,"subjectName":"固收部"}],"approvalRemark":"终审节点，按配置处理人审批"},{"id":"n6","type":"auto","label":"O32自动审批","x":400,"y":540,"shape":"rect"},{"id":"n7","type":"end","label":"结束","x":400,"y":660,"shape":"circle"}]',
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND"},{"id":"e2","from":"n2","to":"n3","label":"提交","condRules":[],"condLogic":"AND"},{"id":"e3","from":"n3","to":"n4","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e4","from":"n4","to":"n3","label":"重新提交","condRules":[],"condLogic":"AND","routeAction":"approve"},{"id":"e5","from":"n3","to":"n5","label":"复核通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e6","from":"n5","to":"n7","label":"不通过","condRules":[{"field":"auditStatus","op":"eq","val":"不通过"}],"condLogic":"AND","routeAction":"reject"},{"id":"e7","from":"n5","to":"n6","label":"通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e8","from":"n4","to":"n7","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e9","from":"n6","to":"n7","label":"","condRules":[],"condLogic":"AND"}]',
 0, 0, 1, 1001, '2026-05-20 09:00:00', 1001, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(13411,1341,134,'n1','start','开始','circle',120,240,NULL,1,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(13412,1341,134,'n2','approval','研究组审批','rect',360,240,'research-team',2,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(13413,1341,134,'n3','auto','同步入库结果','rect',600,240,NULL,3,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(13414,1341,134,'n4','end','结束','circle',840,240,NULL,4,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(13511,1351,135,'n1','start','开始','circle',100,240,NULL,1,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(13512,1351,135,'n2','approval','信用研究审批','rect',320,180,'credit-research',2,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(13513,1351,135,'n3','approval','风控复核','rect',540,300,'risk-officer',3,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(13514,1351,135,'n4','auto','同步主体白名单','rect',760,240,NULL,4,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(13515,1351,135,'n5','end','结束','circle',980,240,NULL,5,'2026-06-12 09:00:00','2026-06-12 10:30:00');
...
(13411,1341,134,'e1',13411,13412,'提交','submit','AND',NULL,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(13412,1341,134,'e2',13412,13413,'审批通过','approve','AND',NULL,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(13413,1341,134,'e3',13413,13414,'同步完成','auto','AND',NULL,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(13511,1351,135,'e1',13511,13512,'提交','submit','AND',NULL,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(13512,1351,135,'e2',13512,13513,'研究审批通过','approve','AND',NULL,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(13513,1351,135,'e3',13513,13514,'复核通过','approve','AND',NULL,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(13514,1351,135,'e4',13514,13515,'同步完成','auto','AND',NULL,'2026-06-12 09:00:00','2026-06-12 10:30:00');
...
SELECT n.id
      ...
      ,CASE n.id
           ...
           WHEN 13412 THEN '股票入库由研究组任一人员完成审批'
           WHEN 13512 THEN '发行人主体准入由信用研究组先行评估'
           WHEN 13513 THEN '发行人主体准入由风控人员复核'
       END
      ,n.crte_time
      ,n.updt_time
FROM `wf_flow_node` n
WHERE n.id IN (12113,12212,12312,12413,12414,12512,12612,12712,12713,12812,12912,12923,13013,13112,13122,13313,13412,13512,13513);
...
(124132,12413,'user',2,'研究员2',2,'2026-05-24 09:00:00','2026-05-24 15:40:00'),
...
(126121,12612,'user',2,'研究员2',1,'2026-05-26 09:30:00','2026-05-26 12:00:00'),
...
(128122,12812,'user',2,'研究员2',2,'2026-05-28 08:30:00','2026-05-28 09:45:00'),
(129121,12912,'role',1,'基金经理',1,'2026-05-10 10:00:00','2026-05-10 15:00:00'),
(129231,12923,'user',2,'研究员2',1,'2026-06-02 09:00:00','2026-06-02 11:30:00'),
...
(134121,13412,'role',1,'基金经理',1,'2026-06-10 09:00:00','2026-06-10 10:00:00'),
(135121,13512,'role',2,'信用研究组',1,'2026-06-12 09:00:00','2026-06-12 10:30:00'),
(135131,13513,'role',3,'风险管理部',1,'2026-06-12 09:00:00','2026-06-12 10:30:00');
...
(134131,13413,1,'updatePosition','股票入库审批通过后同步持仓与投资池状态。','2026-06-10 09:00:00','2026-06-10 10:00:00'),
(135141,13514,1,'riskCheck','主体准入复核通过后执行风控检查并归档。','2026-06-12 09:00:00','2026-06-12 10:30:00'),
(135142,13514,2,'archiveRecord','主体准入复核通过后执行风控检查并归档。','2026-06-12 09:00:00','2026-06-12 10:30:00');
...
WHERE v.flow_id BETWEEN 121 AND 135;
