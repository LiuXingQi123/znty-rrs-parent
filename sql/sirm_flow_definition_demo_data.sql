...
-- ============================================================================
-- 5. 扩展测试场景（flow 121-133）
--    补齐 credit / other 分类、draft / disabled / deleted 状态、多版本历史及全部节点类型
-- ============================================================================
...
(`id`, `name`, `flow_key`, `category`, `description`, `remark`, `status`, `created_by`, `updated_by`, `is_deleted`,
 `crte_time`, `updt_time`)
VALUES
(121, '信用债准入审批流程', 'credit:admission-review', 'credit',
 '信用债首次准入时按评级分支审批，通过后执行风控检查并归档。', '覆盖评级条件、审批和多自动任务。', 'active',
 1001, 1001, 0, '2026-05-21 09:10:00', '2026-05-21 10:30:00'),
(122, '信用债评级下调处置流程', 'credit:rating-downgrade', 'credit',
 '信用评级下调后由信用研究组复核，并向指定人员发送处置通知。', '覆盖驳回路径与指定人员通知。', 'active',
 1001, 1001, 0, '2026-05-22 09:20:00', '2026-05-22 11:00:00'),
(123, '信用债临时额度申请流程', 'credit:temporary-limit', 'credit',
 '信用债临时额度申请草稿，待补充大额条件和审批人后发布。', '从未发布的草稿流程，允许修改流程 Key。', 'draft',
...
(130, '发行人观察名单审批流程', 'credit:issuer-watchlist', 'credit',
...
(1301, 130, 'credit:issuer-watchlist', 1, 'active', '发行人观察名单初始版本',
...
(12214,12214,JSON_ARRAY('system','email'),'person',JSON_ARRAY('risk-officer','invest-director'),
 '信用债【#{procName}】评级下调处置已进入执行阶段。','通知风控人员和投资总监。','2026-05-22 09:20:00','2026-05-22 11:00:00'),
