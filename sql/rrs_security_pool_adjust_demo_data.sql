...
-- 普通债2 在境外债库
('109009012.IB', '25国贸SCP', 'scp', '手工调整', '调入', 'BOND20260308001', 9, 24, '境外债一级库', 'offshore_bond', 105, 'bond:fast-inbound', 'normalInbound', '20', '1', '管理员', '在境外债一级库', '2026-03-08 09:00:00', '2026-03-08 14:00:00', '2026-03-08 14:00:00', 0, NOW(), NOW()),
-- 主体1 在一级库
...
-- 主体5 在债券禁止库（触发禁止库校验）
('C10005', '地产公司', 'company', '手工调整', '调入', 'BOND20260312001', 13, 15, '债券禁止库', 'forbidden', NULL, NULL, NULL, '20', '1', '管理员', '主体在债券禁止库', '2026-03-12 09:00:00', '2026-03-12 14:00:00', '2026-03-12 14:00:00', 0, NOW(), NOW());
...
(9, '109009012.IB', '25国贸SCP', 'scp', '手工调整', '调入', 'BOND20260308001', 24, '境外债一级库', 'offshore_bond', 105, 'bond:fast-inbound', 'normalInbound', '20', '1', '管理员', '普通债2调入境外债一级库', '2026-03-08 09:00:00', '2026-03-08 14:00:00', '2026-03-08 14:00:00', 0, NOW(), NOW()),
-- === 债券-待审批(00) ===
...
(16, 'C10005', '地产公司', 'company', '手工调整', '调入', 'BOND20260312001', 15, '债券禁止库', 'forbidden', NULL, NULL, NULL, '20', '1', '管理员', '主体调入债券禁止库', '2026-03-12 09:00:00', '2026-03-12 14:00:00', '2026-03-12 14:00:00', 0, NOW(), NOW()),
-- === 主体-待审批(00) ===
...
-- === CRMW-已通过(20) ===
(18, '101901234.IB', '24交投MTN001', 'mtn', '手工调整', '调入', 'CRMW20260301001', 18, 'CRMW库', 'crmw', 105, 'bond:fast-inbound', 'normalInbound', '20', '1', '管理员', 'CRMW调入CRMW库', '2026-03-01 09:00:00', '2026-03-01 14:00:00', '2026-03-01 14:00:00', 0, NOW(), NOW()),
(19, 'C10005', '地产公司', 'company', '手工调整', '调入', 'CRMW20260302001', 18, 'CRMW库', 'crmw', 105, 'bond:fast-inbound', 'normalInbound', '20', '1', '管理员', 'CRMW5调入CRMW库（已在池）', '2026-03-02 09:00:00', '2026-03-02 14:00:00', '2026-03-02 14:00:00', 0, NOW(), NOW()),
-- === CRMW-待审批(00) ===
(20, '102002345.IB', '23城投MTN', 'mtn', '手工调整', '调入', 'CRMW20260715001', 18, 'CRMW库', 'crmw', 105, 'bond:fast-inbound', 'normalInbound', '00', '1', '管理员', 'CRMW调入CRMW库待审批', '2026-07-15 09:00:00', NULL, NULL, 0, NOW(), NOW());
...
-- 债券禁止库：log 16 已通过（主体入债券禁止库，无审批流程直通）
