...
-- 基金1 在基金池
('159001.SH', '测试基金A', 'etf_fund', '手工调整', '调入', 'BOND20260309001', 10, 22, '基金池', 'fund', 105, 'bond:fast-inbound', 'normalInbound', '20', '1', '管理员', '基金在基金池', '2026-03-09 09:00:00', '2026-03-09 09:00:00', '2026-03-09 09:00:00', 0, NOW(), NOW()),
-- 主体1 在一级库
...
-- 主体5 在禁止库（触发禁止库校验）
('C10005', '地产公司', 'company', '手工调整', '调入', 'BOND20260312001', 13, 15, '禁止库', 'forbidden', NULL, NULL, NULL, '20', '1', '管理员', '主体在禁止库', '2026-03-12 09:00:00', '2026-03-12 14:00:00', '2026-03-12 14:00:00', 0, NOW(), NOW());
...
-- === 基金-已通过(20) ===
(14, '159001.SH', '测试基金A', 'etf_fund', '手工调整', '调入', 'BOND20260309001', 22, '基金池', 'fund', 105, 'bond:fast-inbound', 'normalInbound', '20', '1', '管理员', '基金调入基金池', '2026-03-09 09:00:00', '2026-03-09 09:00:00', '2026-03-09 09:00:00', 0, NOW(), NOW()),
-- === 主体-已通过(20) ===
...
(16, 'C10005', '地产公司', 'company', '手工调整', '调入', 'BOND20260312001', 15, '禁止库', 'forbidden', NULL, NULL, NULL, '20', '1', '管理员', '主体调入禁止库', '2026-03-12 09:00:00', '2026-03-12 14:00:00', '2026-03-12 14:00:00', 0, NOW(), NOW()),
-- === 主体-待审批(00) ===
