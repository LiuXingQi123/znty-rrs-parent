...
(101, '债券标准升库流程', 'bond:standard-upgrade', 'bond',
 '债券标准升库审批：研究员A发起→研究员B复核→研究总监审批→O32自动审批', '', 'active', 1, 1, 0,
 '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(102, '债券标准降库流程', 'bond:standard-downgrade', 'bond',
 '债券标准降库审批：研究员A发起→研究员B复核→研究总监审批→O32自动审批', '', 'active', 1, 1, 0,
 '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
-- 基金标准流程（升/降库）
(103, '基金标准升库流程', 'fund:standard-upgrade', 'fund',
 '基金标准升库审批：研究员A发起→研究员B复核→研究总监审批→O32自动审批', '', 'active', 1, 1, 0,
 '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(104, '基金标准降库流程', 'fund:standard-downgrade', 'fund',
 '基金标准降库审批：研究员A发起→研究员B复核→研究总监审批→O32自动审批', '', 'active', 1, 1, 0,
 '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
-- 债券快速/白名单/批量/特殊策略 入库
(105, '债券快速入库流程', 'bond:fast-inbound', 'bond', '债券快速入库：研究员A发起→研究员B复核→O32自动审批后入库', '', 'active',
 1, 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(106, '债券白名单入库流程', 'bond:whitelist-inbound', 'bond', '债券白名单入库：研究员A发起后直接入库', '', 'active',
 1, 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(107, '债券批量入库流程', 'bond:batch-inbound', 'bond', '债券批量入库：研究员A发起后批量直接入库', '', 'active', 1,
 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(108, '债券特殊策略入库流程', 'bond:special-inbound', 'bond', '债券特殊策略入库：同标准升库流程，适用于特殊投资策略标的',
 '', 'active', 1, 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
-- 基金快速/白名单/批量/特殊策略 入库
...
(110, '基金白名单入库流程', 'fund:whitelist-inbound', 'fund', '基金白名单入库：研究员A发起后直接入库', '', 'active',
 1, 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(111, '基金批量入库流程', 'fund:batch-inbound', 'fund', '基金批量入库：研究员A发起后批量直接入库', '', 'active', 1,
 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(114, '债券白名单出库流程', 'bond:whitelist-outbound', 'bond', '债券白名单出库：研究员A发起后直接出库', '', 'active',
 1, 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(115, '债券批量出库流程', 'bond:batch-outbound', 'bond', '债券批量出库：研究员A发起后批量直接出库', '', 'active', 1,
 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(118, '基金白名单出库流程', 'fund:whitelist-outbound', 'fund', '基金白名单出库：研究员A发起后直接出库', '', 'active',
 1, 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(119, '基金批量出库流程', 'fund:batch-outbound', 'fund', '基金批量出库：研究员A发起后批量直接出库', '', 'active', 1,
 1, 0, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(105, 105, 'bond:fast-inbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":150,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"approval","label":"研究员B复核","x":400,"y":280,"shape":"rect","sub":"researcher-b","approvalStrategy":"preempt","approvalPersons":[{"handlerType":"role","handlerId":2,"handlerName":"信用研究组"},{"handlerType":"user","handlerId":3,"handlerName":"研究员2"}],"approvalRemark":"复核节点，支持角色和人员混选，任一处理人通过即可"},{"id":"n4","type":"approval","label":"研究员A修改","x":650,"y":280,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"驳回后由流程发起人修改并重新提交"},{"id":"n5","type":"approval","label":"O32自动审批","x":400,"y":410,"shape":"rect","approvalStrategy":"o32","approvalPersons":[{"handlerType":"role","handlerId":2,"handlerName":"信用研究组"},{"handlerType":"user","handlerId":3,"handlerName":"研究员2"},{"handlerType":"user","handlerId":1,"handlerName":"管理员"}],"approvalRemark":"O32系统自动审批，非临时代码系统代审，临时代码转人工"},{"id":"n6","type":"end","label":"结束","x":400,"y":530,"shape":"circle"}]',
...
(106, 106, 'bond:whitelist-inbound', 1, 'active', '初始版本',
 ...
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"},{"id":"e2","from":"n2","to":"n3","label":"直接入库","condRules":[],"condLogic":"AND","routeAction":"submit"}]',
 0, 0, 1, 1, '2026-05-20 09:00:00', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),

(107, 107, 'bond:batch-inbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":160,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"end","label":"结束","x":400,"y":280,"shape":"circle"}]',
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"},{"id":"e2","from":"n2","to":"n3","label":"批量入库","condRules":[],"condLogic":"AND","routeAction":"submit"}]',
 0, 0, 1, 1, '2026-05-20 09:00:00', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),

-- ===== 债券特殊策略入库（同标准流程，flow 108） =====
(108, 108, 'bond:special-inbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":150,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"approval","label":"研究员B复核","x":400,"y":280,"shape":"rect","sub":"researcher-b","approvalStrategy":"preempt","approvalPersons":[{"handlerType":"role","handlerId":2,"handlerName":"信用研究组"},{"handlerType":"user","handlerId":3,"handlerName":"研究员2"}],"approvalRemark":"复核节点，支持角色和人员混选，任一处理人通过即可"},{"id":"n4","type":"approval","label":"研究员A修改","x":650,"y":280,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"驳回后由流程发起人修改并重新提交"},{"id":"n5","type":"approval","label":"研究总监审批","x":400,"y":410,"shape":"rect","sub":"research-director","approvalStrategy":"all","approvalPersons":[{"handlerType":"user","handlerId":3,"handlerName":"研究员2"},{"handlerType":"role","handlerId":4,"handlerName":"固收部"}],"approvalRemark":"终审节点，配置的全部处理人均需处理"},{"id":"n6","type":"approval","label":"O32自动审批","x":400,"y":540,"shape":"rect","approvalStrategy":"o32","approvalPersons":[{"handlerType":"role","handlerId":2,"handlerName":"信用研究组"},{"handlerType":"user","handlerId":3,"handlerName":"研究员2"},{"handlerType":"user","handlerId":1,"handlerName":"管理员"}],"approvalRemark":"O32系统自动审批，非临时代码系统代审，临时代码转人工"},{"id":"n7","type":"end","label":"结束","x":400,"y":660,"shape":"circle"}]',
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"},{"id":"e2","from":"n2","to":"n3","label":"提交","condRules":[],"condLogic":"AND","routeAction":"submit"},{"id":"e3","from":"n3","to":"n4","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e4","from":"n4","to":"n3","label":"重新提交","condRules":[],"condLogic":"AND","routeAction":"resubmit"},{"id":"e5","from":"n3","to":"n5","label":"复核通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e6","from":"n5","to":"n7","label":"不通过","condRules":[{"field":"auditStatus","op":"eq","val":"不通过"}],"condLogic":"AND","routeAction":"reject"},{"id":"e7","from":"n5","to":"n6","label":"通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e8","from":"n4","to":"n7","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e9","from":"n6","to":"n7","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"}]',
 0, 0, 1, 1, '2026-05-20 09:00:00', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(113, 113, 'bond:fast-outbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":160,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"end","label":"结束","x":400,"y":280,"shape":"circle"}]',
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"},{"id":"e2","from":"n2","to":"n3","label":"直接出库","condRules":[],"condLogic":"AND","routeAction":"submit"}]',
 0, 0, 1, 1, '2026-05-20 09:00:00', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(115, 115, 'bond:batch-outbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":160,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"end","label":"结束","x":400,"y":280,"shape":"circle"}]',
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"},{"id":"e2","from":"n2","to":"n3","label":"批量出库","condRules":[],"condLogic":"AND","routeAction":"submit"}]',
 0, 0, 1, 1, '2026-05-20 09:00:00', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),

-- ===== 债券特殊策略出库（同标准，flow 116） =====
(116, 116, 'bond:special-outbound', 1, 'active', '初始版本',
 '[{"id":"n1","type":"start","label":"开始","x":400,"y":40,"shape":"circle"},{"id":"n2","type":"approval","label":"研究员A发起","x":400,"y":150,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"由流程发起人提交，系统自动完成该节点"},{"id":"n3","type":"approval","label":"研究员B复核","x":400,"y":280,"shape":"rect","sub":"researcher-b","approvalStrategy":"preempt","approvalPersons":[{"handlerType":"role","handlerId":4,"handlerName":"固收部"},{"handlerType":"user","handlerId":7,"handlerName":"固收1"}],"approvalRemark":"复核节点，支持角色和人员混选，任一处理人通过即可"},{"id":"n4","type":"approval","label":"研究员A修改","x":650,"y":280,"shape":"rect","sub":"researcher-a","approvalStrategy":"initiator","approvalPersons":[],"approvalRemark":"驳回后由流程发起人修改并重新提交"},{"id":"n5","type":"approval","label":"研究总监审批","x":400,"y":410,"shape":"rect","sub":"research-director","approvalStrategy":"preempt","approvalPersons":[{"handlerType":"user","handlerId":3,"handlerName":"研究员2"},{"handlerType":"role","handlerId":4,"handlerName":"固收部"}],"approvalRemark":"终审节点，按配置处理人审批"},{"id":"n6","type":"approval","label":"O32自动审批","x":400,"y":540,"shape":"rect","approvalStrategy":"o32","approvalPersons":[{"handlerType":"role","handlerId":2,"handlerName":"信用研究组"},{"handlerType":"user","handlerId":3,"handlerName":"研究员2"},{"handlerType":"user","handlerId":1,"handlerName":"管理员"}],"approvalRemark":"O32系统自动审批，非临时代码系统代审，临时代码转人工"},{"id":"n7","type":"end","label":"结束","x":400,"y":660,"shape":"circle"}]',
 '[{"id":"e1","from":"n1","to":"n2","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"},{"id":"e2","from":"n2","to":"n3","label":"提交","condRules":[],"condLogic":"AND","routeAction":"submit"},{"id":"e3","from":"n3","to":"n4","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e4","from":"n4","to":"n3","label":"重新提交","condRules":[],"condLogic":"AND","routeAction":"resubmit"},{"id":"e5","from":"n3","to":"n5","label":"复核通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e6","from":"n5","to":"n7","label":"不通过","condRules":[{"field":"auditStatus","op":"eq","val":"不通过"}],"condLogic":"AND","routeAction":"reject"},{"id":"e7","from":"n5","to":"n6","label":"通过","condRules":[{"field":"auditStatus","op":"eq","val":"通过"}],"condLogic":"AND","routeAction":"approve"},{"id":"e8","from":"n4","to":"n7","label":"驳回","condRules":[{"field":"auditStatus","op":"eq","val":"驳回"}],"condLogic":"AND","routeAction":"reject"},{"id":"e9","from":"n6","to":"n7","label":"","condRules":[],"condLogic":"AND","routeAction":"auto"}]',
 0, 0, 1, 1, '2026-05-20 09:00:00', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(10105, 101, 101, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(10106, 101, 101, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(10205, 102, 102, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(10206, 102, 102, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(10305, 103, 103, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(10306, 103, 103, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(10405, 104, 104, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(10406, 104, 104, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(10504, 105, 105, 'n4', 'approval', '研究员A修改', 'rect', 650, 280, 'researcher-a', 4, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(10505, 105, 105, 'n5', 'approval', 'O32自动审批', 'rect', 400, 410, NULL, 5, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(10805, 108, 108, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(10806, 108, 108, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(10904, 109, 109, 'n4', 'approval', '研究员A修改', 'rect', 650, 280, 'researcher-a', 4, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(10905, 109, 109, 'n5', 'approval', 'O32自动审批', 'rect', 400, 410, NULL, 5, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(11205, 112, 112, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(11206, 112, 112, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(11605, 116, 116, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(11606, 116, 116, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(12005, 120, 120, 'n5', 'approval', '研究总监审批', 'rect', 400, 410, 'research-director', 5, '2026-05-20 09:00:00',
 '2026-05-20 09:00:00'),
(12006, 120, 120, 'n6', 'approval', 'O32自动审批', 'rect', 400, 540, NULL, 6, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
INNER JOIN (
    SELECT 1 AS seq, 'e1' AS edge_code, 'n1' AS from_code, 'n2' AS to_code, '' AS label, 'auto' AS route_action
    UNION ALL SELECT 2, 'e2', 'n2', 'n3', '提交', 'submit'
    UNION ALL SELECT 3, 'e3', 'n3', 'n4', '驳回', 'reject'
    UNION ALL SELECT 4, 'e4', 'n4', 'n3', '重新提交', 'resubmit'
    ...
    UNION ALL SELECT 9, 'e9', 'n6', 'n7', '', 'auto'
) e
...
INNER JOIN (
    ...
    UNION ALL SELECT 7, 'e7', 'n5', 'n6', '', 'auto'
) e
INNER JOIN `wf_flow_node` fn ON fn.version_id = v.id AND fn.node_id = e.from_code
INNER JOIN `wf_flow_node` tn ON tn.version_id = v.id AND tn.node_id = e.to_code
...
SELECT v.id * 1000 + e.seq
      ...
      ,CASE
           ...
           ELSE '直接处理'
       END
      ,CASE WHEN e.seq = 2 THEN 'submit' ELSE 'auto' END
      ,'AND'
      ,NULL
      ,'2026-05-20 09:00:00'
      ,'2026-05-20 09:00:00'
...
-- O32 自动审批节点配置（approval_strategy=o32：非临时代码系统代审，临时代码转人工抢占）
...
(10505, 10505, 'o32', 'O32系统自动审批，临时代码转人工', '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(10806, 10806, 'o32', 'O32系统自动审批，临时代码转人工', '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(10905, 10905, 'o32', 'O32系统自动审批，临时代码转人工', '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(11206, 11206, 'o32', 'O32系统自动审批，临时代码转人工', '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(11606, 11606, 'o32', 'O32系统自动审批，临时代码转人工', '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(12006, 12006, 'o32', 'O32系统自动审批，临时代码转人工', '2026-05-20 09:00:00', '2026-05-20 09:00:00');
...
(101051, 10105, 'user', 3, '研究员2', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(102032, 10203, 'user', 7, '固收1', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(102051, 10205, 'role', 4, '固收部', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(102052, 10205, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(103031, 10303, 'role', 7, '权益部', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(103032, 10303, 'user', 13, '权益3', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(104032, 10403, 'user', 14, '量化1', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(105032, 10503, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(108031, 10803, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(108032, 10803, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(108051, 10805, 'user', 3, '研究员2', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(109032, 10903, 'user', 13, '权益3', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(112031, 11203, 'role', 7, '权益部', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(112032, 11203, 'user', 13, '权益3', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(112051, 11205, 'role', 7, '权益部', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(112052, 11205, 'user', 1, '管理员', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(116031, 11603, 'role', 4, '固收部', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(116032, 11603, 'user', 7, '固收1', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(116051, 11605, 'user', 3, '研究员2', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
...
(120032, 12003, 'user', 14, '量化1', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(120051, 12005, 'role', 9, '量化部', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(120052, 12005, 'user', 1, '管理员', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
-- O32 自动审批节点处理人（系统代审时记录处理人，临时代码转人工时由处理人审核，抢占任一人通过即完成）
(101061, 10106, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(101062, 10106, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(101063, 10106, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(102061, 10206, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(102062, 10206, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(102063, 10206, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(103061, 10306, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(103062, 10306, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(103063, 10306, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(104061, 10406, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(104062, 10406, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(104063, 10406, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(105051, 10505, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(105052, 10505, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(105053, 10505, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(108061, 10806, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(108062, 10806, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(108063, 10806, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(109051, 10905, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(109052, 10905, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(109053, 10905, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(112061, 11206, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(112062, 11206, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(112063, 11206, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(116061, 11606, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(116062, 11606, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(116063, 11606, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(120061, 12006, 'role', 2, '信用研究组', 1, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(120062, 12006, 'user', 3, '研究员2', 2, '2026-05-20 09:00:00', '2026-05-20 09:00:00'),
(120063, 12006, 'user', 1, '管理员', 3, '2026-05-20 09:00:00', '2026-05-20 09:00:00');
