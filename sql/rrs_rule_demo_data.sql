...
(104,38,'信用债大库(new)','信用债大库(new)',1,NOW(),NOW()),(105,38,'信用债大库(old)','信用债大库(old)',2,NOW(),NOW()),
(106,38,'境外债','境外债',3,NOW(),NOW()),(107,38,'转债库','转债库',4,NOW(),NOW()),
(108,38,'债券禁止库','债券禁止库',5,NOW(),NOW()),
