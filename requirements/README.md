...
本目录按前端业务页面整理需求，共 11 个功能。接口统一使用 `POST`，返回 `ApiResponse<T>`；成功时 `code=0`、`message=success`。
...
| 04 | 证券池调库申请 | `security_pool_adjust.html` | [04-security-pool-adjust.md](04-security-pool-adjust.md) | `SecurityPoolAdjustApiTest` |
| 05 | 证券池调库审核 | `security_pool_adjust_approve.html` | [05-security-pool-adjust-approve.md](05-security-pool-adjust-approve.md) | `SecurityPoolAdjustApproveApiTest` |
