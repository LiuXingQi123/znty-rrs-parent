 ...
 */
@Mapper
public interface ForbiddenAbsPoolAdjustMapper {
    ...
    /** 更新调库详情页传入的证券基础信息字段 */
    int editSecurityInfoForAdjust(ForbiddenAbsPoolAdjustSubmitReq req);
    ...
    /** 查询证券是否在全局禁投池（forbidden，audit_status=20），用于调入禁投池校验 */
